...
Picture.create(url: "08-ohmy-logo1.jpg", project_id: g.id)
Picture.create(url: "08-ohmy-logo3.jpg", project_id: g.id)
Picture.create(url: "08-ohmy-logo4.jpg", project_id: g.id)
Picture.create(url: "08-ohmy-logo5.jpg", project_id: g.id)
