...
b = Project.create(name: "Electra", background: "#224a88", description:"Organic typeface based on the work of Charles Dwiggins. Download here.")
...
Picture.create(url: "00-ohmy-text3.gif", project_id: a.id)
Picture.create(url: "00-ohmy-text4.gif", project_id: a.id)
Picture.create(url: "00-ohmy-text5.gif", project_id: a.id)
Picture.create(url: "00-ohmy-text6.png", project_id: a.id)
Picture.create(url: "00-ohmy-text7.png", project_id: a.id)
Picture.create(url: "00-ohmy-text8.png", project_id: a.id)
Picture.create(url: "00-ohmy-text9.png", project_id: a.id)
Picture.create(url: "00-ohmy-text10.png", project_id: a.id)
Picture.create(url: "00-ohmy-text11.png", project_id: a.id)
Picture.create(url: "00-ohmy-text12.png", project_id: a.id)

Picture.create(url: "01-ohmy-electra0.png", project_id: b.id)
...
Picture.create(url: "05-ohmy-webarchive2.png", project_id: e.id)
Picture.create(url: "05-ohmy-webarchive3.png", project_id: e.id)
...
Picture.create(url: "09-ohmy-experiment2.gif", project_id: h.id)
